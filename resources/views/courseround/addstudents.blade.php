...
<div class="card">
    ...
    <div class="card-body">
      <h5 class="card-title">Add student in {{ $course_rounds->course->name}} {{ ':' }} {{  $course_rounds->round->round_number }}</h5>


      <form class="row form" method="POST" action="{{ route('courserounds.storestudent',$course_round_id) }}">
        @csrf
